...
const WalletHeader = () => {
  ...
  return (
    <header className="sticky top-0 z-50 bg-white border-b-[1px]">
        ...
        >
          ...
          <Stack spacing={1} alignItems={"center"} direction={"row"}>
            ...
            <Button
              ...
              variant="text"
              className="rotate-[180] lg:hidden hover:bg-gray-400 duration-500 text-black text-[15px] leading-[16px]"
            >
