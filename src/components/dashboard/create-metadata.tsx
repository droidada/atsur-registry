            ...
            <form
                ...
                <div className="flex gap30">
                    <fieldset className="collection">
                        <label>Rarity</label>
                        <select className="select" tabIndex={2} name="rarity" id="rarity" {...register("rarity")}>
                    ...
                    <fieldset className="collection">
                        <label>Type</label>
                        <select className="select" tabIndex={2} name="type" id="type" {...register("type")}>
                            <option>Select</option>
                ...
                <div className="btn-submit flex gap30 justify-center">
                    <button className="tf-button style-1 h50 active" type="reset">Clear<i className="icon-arrow-up-right2" /></button>
                    <LoadingButton className="tf-button style-1 h50" loading={loading} type="submit">Create<i className="icon-arrow-up-right2" /></LoadingButton>
                </div>
            </form>
        </div>
    </>
