            ...
            <div className="wrap-upload w-full">
                <form
                    ...
                    <label className="uploadfile" style={{ marginBottom: "3%" }}>
                        {leftImg ? <img className="h-full w-full" src={leftImg} /> : <img src="assets/images/box-icon/upload.png" alt="" />}
                        ...
                        <input type="file" name="leftImage" accept="image/*" onChange={handleLeftImgUploadClick} />
                    </label>
                    <br />
                    <label className="uploadfile" style={{ marginBottom: "3%" }}>
                        {rightImg ? <img className="h-full w-full" src={rightImg} /> : <img src="assets/images/box-icon/upload.png" alt="" />}
                        ...
                        <input type="file" name="rightImage" accept="image/*" onChange={handleRightImgUploadClick} />
                    </label>{" "}
                    <br />
                    <label className="uploadfile">
                        {mountedImg ? <img className="h-full w-full" src={mountedImg} /> : <img src="assets/images/box-icon/upload.png" alt="" />}
                        ...
                        <input type="file" name="mountedImage" accept="image/*" onChange={handleMountedImgUploadClick} />
                    </label>
