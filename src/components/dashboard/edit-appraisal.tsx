...
import { Button, TextField, Select, Divider, MenuItem, Dialog, DialogActions, DialogContent, DialogContentText, DialogTitle } from '@mui/material';
import { object, string, TypeOf } from "zod";
import { zodResolver } from "@hookform/resolvers/zod";
import { useForm, SubmitHandler } from "react-hook-form";
import useAxiosAuth from "@/hooks/useAxiosAuth";

export default function EditAppraisal({open, handleClose, artPieceId, appraisal = {}}) {
  ...
  return (
    <>
      ...
      >
        ...
        >
          <DialogTitle><h2 className="items-center justify-center">Appraisal</h2></DialogTitle>
          <DialogContent>
            <DialogContentText>
