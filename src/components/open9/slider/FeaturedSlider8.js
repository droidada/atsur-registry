      ...
      >
        <SwiperSlide>
          <div className="tf-card-box style-4">
            ...
            <div className="card-media">
              <Link href="#">
                <Image src="/assets/images/box-item/card-item-59.jpg" alt="" />
              </Link>
        ...
        <SwiperSlide>
          <div className="tf-card-box style-4">
            ...
            <div className="card-media">
              <Link href="#">
                <Image src="/assets/images/box-item/card-item-50.jpg" alt="" />
              </Link>
              <span className="wishlist-button icon-heart" />
            </div>
            <h5 className="name">
        ...
        <SwiperSlide>
          <div className="tf-card-box style-4">
            ...
            <div className="card-media">
              <Link href="#">
                <Image src="/assets/images/box-item/card-item-51.jpg" alt="" />
              </Link>
              <span className="wishlist-button icon-heart" />
            </div>
            <h5 className="name">
        ...
        <SwiperSlide>
          <div className="tf-card-box style-4">
            ...
            <div className="card-media">
              <Link href="#">
                <Image src="/assets/images/box-item/card-item-52.jpg" alt="" />
              </Link>
              <span className="wishlist-button icon-heart" />
            </div>
            <h5 className="name">
        ...
        <SwiperSlide>
          <div className="tf-card-box style-4">
            ...
            <div className="card-media">
              <Link href="#">
                <Image src="/assets/images/box-item/card-item-53.jpg" alt="" />
              </Link>
              <span className="wishlist-button icon-heart" />
            </div>
            <h5 className="name">
        ...
        <SwiperSlide>
          <div className="tf-card-box style-4">
            ...
            <div className="card-media">
              <Link href="#">
                <Image src="/assets/images/box-item/card-item-54.jpg" alt="" />
              </Link>
              <span className="wishlist-button icon-heart" />
            </div>
            <h5 className="name">
        ...
        <SwiperSlide>
          <div className="tf-card-box style-4">
            ...
            <div className="card-media">
              <Link href="#">
                <Image src="/assets/images/box-item/card-item-55.jpg" alt="" />
              </Link>
              <span className="wishlist-button icon-heart" />
            </div>
            <h5 className="name">
