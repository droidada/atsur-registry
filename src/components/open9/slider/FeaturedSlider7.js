      ...
      >
        <SwiperSlide>
          <div className="tf-card-box style-1">
            <div className="card-media">
              <Link href="#">
                <Image src="/assets/images/box-item/card-item-46.jpg" alt="" />
              </Link>
        ...
        <SwiperSlide>
          <div className="tf-card-box style-1">
            <div className="card-media">
              <Link href="#">
                <Image src="/assets/images/box-item/card-item-42.jpg" alt="" />
              </Link>
              <span className="wishlist-button icon-heart" />
              <div className="featured-countdown">
                <span
        ...
        <SwiperSlide>
          <div className="tf-card-box style-1">
            <div className="card-media">
              <Link href="#">
                <Image src="/assets/images/box-item/card-item-47.jpg" alt="" />
              </Link>
              <span className="wishlist-button icon-heart" />
              <div className="featured-countdown">
                <span
        ...
        <SwiperSlide>
          <div className="tf-card-box style-1">
            <div className="card-media">
              <Link href="#">
                <Image src="/assets/images/box-item/card-item-44.jpg" alt="" />
              </Link>
              <span className="wishlist-button icon-heart" />
              <div className="featured-countdown">
                <span
        ...
        <SwiperSlide>
          <div className="tf-card-box style-1">
            <div className="card-media">
              <Link href="#">
                <Image src="/assets/images/box-item/card-item-45.jpg" alt="" />
              </Link>
              <span className="wishlist-button icon-heart" />
              <div className="featured-countdown">
                <span
        ...
        <SwiperSlide>
          <div className="tf-card-box style-1">
            <div className="card-media">
              <Link href="#">
                <Image src="/assets/images/box-item/card-item-48.jpg" alt="" />
              </Link>
              <span className="wishlist-button icon-heart" />
              <div className="featured-countdown">
                <span
