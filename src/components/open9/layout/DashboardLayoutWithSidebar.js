      ...
      <ErrorBoundary>
        <div id="market-header" className="bg-white">
          <div className="market-header flex items-center justify-between">
            <div className="widget-search gray-bg">
              <form
                action="#"
                method="get"
                role="search"
                  ...
                  <div className="over-content">
                    <div className="content">
                      ...
                      <ul className="menu-tab">
                        ...
                        <li
                          className={
                            activePage === DashboardPages.COLLECTIONS
                              ? "tablinks active"
                              : "tablinks"
                          }
                          data-tabs="my-collection"
                        >
                          <Link
                        ...
                        <li
                          className={
                            activePage === DashboardPages.ORGANIZATIONS
                              ? "tablinks active"
                              : "tablinks"
                          }
                          data-tabs="ORGANIZATIONS"
                        >
                          <Link
                        ...
                        <li
                          className={
                            activePage === DashboardPages.WISHLIST
                              ? "tablinks active"
                              : "tablinks"
                          }
                          data-tabs="wishlist"
                        ...
                        <li
                          className={
                            activePage === DashboardPages.DEALS
                              ? "tablinks active"
                              : "tablinks"
                          }
                          data-tabs="deals"
                    ...
                    <div className="content mt-30">
                      ...
                      <ul className="menu-tab">
                        ...
                        <li
                          className={
                            activePage === DashboardPages.SECURITY
                              ? "tablinks active"
                              : "tablinks"
                          }
                          data-tabs="security"
