    ...
    return (
        <>
            <div className="wrapper-content" style={{display:'flex'}}>
                                ...
                                <div className="admin_active" id="header_admin">
                                    ...
                                    <div className="popup-user relative">
                                        <div className="user" onClick={handleToggle}>
                                            ...
                                            <span className="tf-color">{`${user?.firstName} ${user?.lastName}`}<i className="icon-keyboard_arrow_down" /></span>
                                        </div>
                ...
                <div className="side-bar" style={{marginTop: '130px', paddingRight: '15px'}}>
