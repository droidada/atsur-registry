                ...
                <div className="over-content">
                  <div className="content">
                    ...
                    <ul className="menu-tab">
                      <li
                        className={
                          activePage === DashboardPages.CREATIONS
                            ? "tablinks active"
                            : "tablinks"
                        }
                        data-tabs="creations"
                  ...
                  <div className="content mt-30">
                    ...
                    <ul className="menu-tab">
                      <li
                        className={
                          activePage === DashboardPages.MY_COLLECTION
                            ? "tablinks active"
                            : "tablinks"
                        }
                      ...
                      <li
                        className={
                          activePage === DashboardPages.VERIFICATION
                            ? "tablinks active"
                            : "tablinks"
                        }
                        data-tabs="verification"
                      >
                        <svg
                          width={22}
                          height={22}
