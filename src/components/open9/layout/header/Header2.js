            ...
            <header id="header_main" className={`header_1 header-fixed  ${scroll ? "is-fixed is-small" : ""}`}>
                                    ...
                                    <div id="site-logo">
                                        <div id="site-logo-inner">
                                            <Link href="/" rel="home" className="main-logo">
                                                <img id="logo_header" src="/images/atsur-logo.svg" data-retina="assets/images/logo/logo-dark@2x.png" />
                                            </Link>
                                        </div>
                                    </div>{/* logo */}
                ...
                <div className={`canvas-nav-wrap ${isSidebar ? "active" : ""}`}>
                    ...
                    <div className="inner-canvas-nav">
                        <div className="side-bar">
                            <Link href="/" rel="home" className="main-logo">
                                <img id="logo_header" src="/images/atsur-logo-white.svg" data-retina="assets/images/logo/logo-dark@2x.png" />
                            </Link>
                            ...
                            <div className="widget widget-categories">
                                ...
                                <ul>
                                    <li>
                                        <div className="cate-item tf-color"><Link href="#">NFTs</Link></div>
                                        <div className="number">(1.483)</div>
                                    </li>
                                    <li>
                                        <div className="cate-item tf-color"><Link href="#">Digital Art</Link></div>
                                        <div className="number">(97)</div>
                                    </li>
                                    <li>
                                        <div className="cate-item tf-color"><Link href="#">Crypto</Link></div>
                                        <div className="number">(45)</div>
                                    </li>
                                    <li>
                                        <div className="cate-item tf-color"><Link href="#">Technology</Link></div>
                ...
                <div className={`mobile-nav-wrap ${isMobileMenu ? "active" : ""}`}>
                    ...
                    <div className="inner-mobile-nav">
                        <Link href="/" rel="home" className="main-logo">
                            <img id="mobile-logo_header" src="/images/atsur-logo-white.svg" data-retina="assets/images/logo/logo-dark@2x.png" />
                        </Link>
