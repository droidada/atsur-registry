                                ...
                                <div className="popup-notification relative">
                                    <div className="notification" onClick={handleToggle2}>
                                        <svg width={24} height={25} viewBox="0 0 24 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            ...
                                            <circle cx={17} cy={5} r={4} fill="#A4442B" stroke="#1D1D1D" strokeWidth="1.5" />
                                        </svg>
                                    </div>
                            ...
                            <div className="over-content">
                                <div className="content">
                                    ...
                                    <ul className="menu-tab">
                                        <li className={activeIndex === 1 ? "tablinks active" : "tablinks"} data-tabs="creations" onClick={() => handleOnClick(1)}>
                                ...
                                <div className="content mt-30">
                                    ...
                                    <ul className="menu-tab">
                                        ...
                                        <li className={activeIndex === 7 ? "tablinks active" : "tablinks"} data-tabs="history" onClick={() => handleOnClick(7)}>
                                            ...
                                            <svg width={22} height={22} viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path fillRule="evenodd" clipRule="evenodd" d="M7.03051 1.83337H14.978C18.0855 1.83337 20.1663 4.01412 20.1663 7.25912V14.7483C20.1663 17.985 18.0855 20.1667 14.978 20.1667H7.03051C3.92301 20.1667 1.83301 17.985 1.83301 14.7483V7.25912C1.83301 4.01412 3.92301 1.83337 7.03051 1.83337ZM14.2813 14.4925C14.5105 14.4925 14.7397 14.3734 14.868 14.1534C15.0697 13.8316 14.9597 13.41 14.6297 13.2092L11.3663 11.2659V7.02996C11.3663 6.65504 11.0638 6.34246 10.6788 6.34246C10.303 6.34246 9.99134 6.65504 9.99134 7.02996V11.66C9.99134 11.8984 10.1197 12.1275 10.3305 12.2467L13.9238 14.3917C14.0338 14.465 14.1622 14.4925 14.2813 14.4925Z" fill="#A4442B" />
                                            </svg>
                                            Verification
                                        </li>
