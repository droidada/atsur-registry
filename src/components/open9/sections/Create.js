    ...
    <div>
        ...
        />
          <div className="box-icon-item">
            ...
            <div className="title"><Link href="#">Artist</Link></div>
            ...
            <div className="wrapper-content-create">
                ...
                <div className="widget-tabs relative">
                    <ul className="widget-menu-tab">
                        <li className={activeIndex === 1 ? "item-title active tf-color" : "item-title"} onClick={() => handleOnClick(1)}>
                        ...
                        <li className={activeIndex === 3 ? "item-title active" : "item-title"} onClick={() => handleOnClick(3)}>
                            <span className="inner"><span className="order">3</span>Provenance</span>
                        </li>
                    </ul>
                    <div className="widget-content-tab">
                        ...
                        <div className={activeIndex === 2 ? "widget-content-inner upload active" : "widget-content-inner upload"} style={{ display: `${activeIndex == 2 ? "" : "none"}` }}>
                                    ...
                                    <div className="row">
                                        <div className="col-md-12">
                                            <div className="heading-section-1">
                                                <h2 className="tf-title pb-20 to-black">Information</h2>
                                                <p className="pb-40 to-black">Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur.</p>
                                            </div>
                                        </div>
                                        <h6 className="pb-2 to-black">Ownership *</h6>
                                        <p className="pb-2 to-black">How would you describe your relationship with the art-piece.</p>
                                        ...
                                        <div data-wow-delay="0.1s" className="wow fadeInUp col-md-4">
                                            <div className="box-icon-item">
                                                ...
                                                <div className="title"><Link href="#">Broker</Link></div>
                                                <p>open9@support.com
                                        ...
                                        <div data-wow-delay="0.2s" className="wow fadeInUp col-md-4">
                                            <div className="box-icon-item">
                                                ...
                                                <div className="title"><Link href="#">Collector</Link></div>
                                                <p>(316) 555-0116 <br />
                                                    (219) 555-0114</p>
                                            </div>
                                        </div>
