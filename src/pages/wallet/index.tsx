...
import { transakConfig } from "@/lib/transk/transk";
...
function Wallet() {
  ...
  let transak = new Transak({...transakConfig, fiatAmount: 20});

  const setup = async () => {
    const { data } = await axiosAuth.get("/user/me");
    console.log("we have user here ", data.user)
    setUser(data.user);
  }
  ...
  useEffect(() => {
    ...
    transak = new Transak({...transakConfig, fiatAmount: 20, email: user?.email, walletAddress: user?.wallet?.address});
      ...
      <div className="main-box max-w-6xl mx-auto container px-2 sm:px-3 md:px-8 relative">
        ...
        <main className="h-full pb-24 px-4 md:px-12 py-12">
          <div className="w-full flex items-center justify-between pb-4 mb-3 flex-wrap relative">
            ...
            <button
              className=" items-center mt-4 lg:mt-0 px-14 py-2 rounded h-12  bg-[#45CD85]  hover:bg-[#45CD85]/80 text-white transition ease-in duration-200 text-center text-sm font-semibold shadow-md justify-center  "
        ...
        <div className={`modal ${openDeposit ? "show" : ""}`}>
          <div className="modal-wrapper shadow-lg rounded-md">
            <div className="flex items-start justify-between mb-5">
              ...
              <button
                className="btn btn-sm btn-label-brand btn-bold flex items-start"
            ...
            <div>
              ...
              <Tabs>
                <TabList className="flex md:flex-row flex-col items-center justify-between w-full tabs-header rounded-md gap-2">
                  <Tab className="w-full py-4 rounded-l-md text-sm outline-none focus-within:border-0 focus:border-0">
                    Fiat Connect
                  </Tab>
                  <Tab className="w-full py-4   text-sm outline-none focus-within:border-0 focus:border-0">
                    Crypto address
                  </Tab>
                  <Tab className="w-full py-4 rounded-r-md text-sm outline-none focus-within:border-0 focus:border-0">
                    Debit Card
                  </Tab>
                </TabList>
                      ...
                      <div className="flex md:flex-row flex-col items-start md:items-center gap-4 flex-wrap">
                        ...
                        <div className="h-12 w-full relative flex-1">
                          ...
                          <input
                            id="cello_address"
                            type="text"
                            className=" block w-full h-full pl-4 pr-14 py-4 text-gray-700 bg-white border border-gray-300 rounded-md focus:outline-none"
                            name="cello_address"
                            defaultValue="0xGI5678vviu9755iNFTDXVH55787"
                          />
                        </div>
                      </div>
                    </div>
                  ...
                  <TabPanel>
                    <div className="fade-in">
                      ...
                      <div className="mb-6 flex md:flex-row flex-col items-start md:items-center gap-4 flex-wrap">
                        <label
                          className="text-gray-700 font-medium w-full md:w-1/5 "
                          htmlFor="cello_address"
                        >
                          Card number
                        </label>
                        <div className="h-12 w-full relative flex-1">
                          <input
                            id="cello_address"
                            type="text"
                            className=" block w-full h-full px-4 py-4 text-gray-700 bg-white border border-gray-300 rounded-md focus:outline-none"
                            name="cello_address"
                            defaultValue="0xGI5678vviu9755iNFTDXVH55787"
                          />
                        </div>
                      ...
                      <div className="mb-6 flex md:flex-row flex-col items-start md:items-center gap-4 flex-wrap">
                        <label
                          className="text-gray-700 font-medium md:w-1/5 "
                          htmlFor="cello_address"
                        >
                          Name on Card
                        </label>
