                    ...
                    <div className="tf-section-2 wrap-accordion pt-80">
                        <div className="themesflat-container">
                            <div className="row">
                                <div className="col-md-12">
                                    <div className="heading-section-1">
                                        <h2 className="tf-title pb-40 to-black">Frequently Asked Questions</h2>
                                    </div>
                                </div>
                                ...
                                <div className="col-12">
                                    <div className="content">
                                        ...
                                        <p>Can&lsquo;t find what you&lsquo;re looking for? Please <Link href="#" className="tf-color">chat to our friendly team</Link></p>
                                    </div>
                                </div>
                            </div>
                        </div>
