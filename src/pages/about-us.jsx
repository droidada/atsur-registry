...
const CounterUp = dynamic(() => import("@/open9/elements/CounterUp"), {
  ssr: false,
});
        ...
        <div>
              ...
              <div className="row">
                <div className="col-12 pages-title">
                  <div className="content">
                    ...
                    >
                      <Link href="#" className="tf-button style-1 h50 w190">
              ...
              <div className="row">
                ...
                <div className="col-md-4">
                  <div className="box-icon-item">
                    ...
                    />
                    <div className="title">
                      <Link href="#">Huge data warehouse</Link>
                    </div>
                    <p>
                      Fusce non dignissim velit, sit amet semper eros. Quisque
                      orci est
                ...
                <div className="col-md-4">
                  <div className="box-icon-item">
                    ...
                    />
                    <div className="title">
                      <Link href="#">3 layer security</Link>
                    </div>
                    <p>
                      Fusce non dignissim velit, sit amet semper eros. Quisque
                      orci est
          ...
          <div className="widget-our-team">
            <div className="themesflat-container">
              ...
              <div className="row">
                <div className="col-12">
                  <Link href="#" className="tf-button style-1 h50 w190 m-auto">
                    Join us
          ...
          <div className="tf-section-2 wrap-accordion pt-80">
            <div className="themesflat-container">
              <div className="row">
                <div className="col-md-12">
                  <div className="heading-section-1">
                    <h2 className="tf-title pb-40 to-black">
