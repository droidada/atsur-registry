                        ...
                        <div className="themesflat-container">
                            <div className="row">
                                <div className="col-12">
                                    <h1 className="heading text-center tf-color">Explore Artworks</h1>
                                    <ul className="breadcrumbs flex justify-center">
                                        <li className="icon-keyboard_arrow_right">
                                            <Link className="to-black" href="/">Home</Link>
                                        </li>
                                        <li>
                                            <Link className="to-black" href="#">Explore</Link>
                                        </li>
                                    </ul>
                                </div>
                                <div className="col-2"></div>
                                <div className="col-8">
                                    <div data-wow-delay="0.2s" className="wow fadeInUp widget-search" style={{marginTop: '20px'}}>
                                                        ...
                                                        <div className="tf-card-box style-1">
                                                            <div className="card-media">
                                                                ...
                                                                <div className="button-place-bid">
                                                                    <Link href="/profile" className="tf-button"><span>Place Bid</span></Link>
                                                                </div>
                                                            </div>
